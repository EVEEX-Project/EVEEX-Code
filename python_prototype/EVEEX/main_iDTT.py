...
Version utilisant la iDTT (integer Discrete Tchebychev Transform), qui est
analogue à la DCT entière (--> cf. iDTT.py).
"""
...
print("\n")
log.debug("Algorithme de compression utilisant la iDTT (ou la iDCT)\n\n")
...
# frame RGB --> frame YUV
image_yuv = round_matrix(enc.RGB_to_YUV(np.array(image_rgb, dtype=float)))
